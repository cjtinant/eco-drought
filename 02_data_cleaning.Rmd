...
gage_meta <- import("data/gage_meta_raw.csv")   
...
```{r export_flow-regime_data}

# export flow regime for lmoment plots====  
flow_regime <- gage_meta %>%  
  select(sta, site_no, flow_regime)  

# export results & clean up data frame  
...
# * helper dataframe====  
gage_ecoreg <- gage_mon %>%  
  select(sta, ecoreg) %>%  
  distinct()  

# export results & clean up====  
export(gage_ecoreg, "data/gage_ecoreg.csv")  
