---
title: "Watershed storage parameters improve streamflow estimation accuracy for ungaged watersheds for a semi-arid region of the Northern Great Plains, USA" 
author:
- "Charles Jason Tinant^1^"
- "Scott J. Kenner^2^"
institute: 
- "^1^STEM Department, Oglala Lakota College"
- "^2^Department of Civil Engineering, South Dakota School of Mines and Technology."
date: "`r Sys.Date()`"
output:
...
background-image: url(data/peec_meatball.png)
