...
* GLM inputs calculated as zonal statistics following watershed boundaries: 3 planimetric, 4 elevation-derived, 4 climate, 1 land cover, 3-soils based metrics (table 1). 
...
# Hypothesis testing
* Penalized generalized linear models (GLMs) trained with 80/20 split and 5-fold cross-validation.  q1 is the response variable, and hydrologic landscape metrics are explanatory variables (table 1). 
* Evaluated GLM predictions to a null model of mean daily flow depths (figure 4).
