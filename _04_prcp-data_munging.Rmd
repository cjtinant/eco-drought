...
gage_raw <- import("data/gage_raw.csv")
...
gage_fin <- full_join(abrev, gage_fin, by = "site_no")
gage_meta <- full_join(abrev, gage_meta, by = "site_no")
rm(station_nm, abrev)

# export and import station df by rio
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# export(gage_fin, "data/gage_gath.csv") 
...
# ~~~~~~~~~~~~~~~~~~~~~
# export(discharge, "data/gage_discharge.csv") 
```
