...
rm(gage_orig, gage_est_0317a, gage_est_0317b, gage_est_9002a, 
   gage_est_9002b, gage_est_9017a, gage_est_9017b, gage_est_9017c, 
   gage_incomp, gage_meta)
```
...
# wet years (sorry!)
gage_input <- gage %>% 
  filter(water_year < 2003)                             # n = 147,188

# dry years (sorry!)
gage_input <- gage %>% 
  filter(water_year >= 2003)                            # n = 169,848
