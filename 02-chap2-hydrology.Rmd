...
# check for na values - these are usually a result of start of record
...
rm(first_mon_cot, first_mon_int, first_mon_oel, 
...
NEED TO FIX MONTH 7 MAXIMUM LIKLIHOOD maximum likelihood estimation failed for month 7 parameters are set to NA.Parameter for month 7 is NA
...
# clean up
rm(spi_index_na, spi_index_outlier, spi_index_replace, 
