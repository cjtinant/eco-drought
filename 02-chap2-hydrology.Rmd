...
```{r SPI_index, eval=FALSE, include=FALSE}
...
# gather data, removes NA vals, spreads & checks for NA
sta_chk <- sta_raw %>% 
  gather(key = "sta", value = "depth", 
         -date, -year, -month) %>% 
  drop_na(depth)  %>% 
...
# create a matrix with SPI values - used below
spi.oel <- transformSCI(int, first.mon = first_mon_oel, 
                        obj = spi.oel.l) 
...
spi.ora <- transformSCI(ora, first.mon = first_mon_ora, obj = spi.ora.l) 
...
spi.rap <- transformSCI(rap, first.mon = first_mon_rap, obj = spi.rap.l) 
...
#   1mon-clean up & combine the SPI variables---- 
...
#   1mon-Pearson Type-III distribution properties---- 
...
#   1mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att1     <- spi_att 
spi_gath1    <- spi_gath
...
#   2mon-check for warnings from SCI----
flag_cot <- as.tibble(spi.cot.l$dist.para.flag) 
...
#   2mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   2mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   2mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att2     <- spi_att 
spi_gath2    <- spi_gath
...
#   3mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
...
#   3mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   3mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att3     <- spi_att 
spi_gath3    <- spi_gath
...
#   4mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   4mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   4mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att4     <- spi_att 
spi_gath4    <- spi_gath
...
#f#irst_mon <- 5 # sets the first month 
...
#   5mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   5mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   5mon-Clean up Global Environment---- 
...
#   6mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   6mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   6mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att6     <- spi_att 
spi_gath6    <- spi_gath
...
#   9mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   9mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   9mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att9     <- spi_att 
spi_gath9    <- spi_gath
...
#   12mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   12mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   12mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att12     <- spi_att 
spi_gath12    <- spi_gath
...
#   18mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   18mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   18mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att18     <- spi_att 
spi_gath18    <- spi_gath
...
#   24mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   24mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   24mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att24     <- spi_att 
spi_gath24    <- spi_gath
...
#   30mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   30mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   30mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att30     <- spi_att 
spi_gath30    <- spi_gath
spi_check30   <- spi_check 
...
#   36mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   36mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   36mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att36     <- spi_att 
spi_gath36    <- spi_gath
spi_check36   <- spi_check 
...
#   42mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   42mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   42mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att42     <- spi_att 
spi_gath42    <- spi_gath
spi_check42   <- spi_check 
...
#   48mon-clean up & combine the SPI variables---- 
rm(spi.cot, spi.int, spi.oel, spi.ora, spi.rap) 
#rm(cot, int, oel, ora, rap) 
...
#   48mon-Pearson Type-III distribution properties---- 
# get names for Pearson-III distribution 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
att_names <- spi.cot.l$dist.para 
att_names <- rownames(att_names) 
...
#   48mon-Clean up Global Environment----
#rm(spi_cot, spi_int, spi_oel, spi_ora, spi_rap)
spi_att48     <- spi_att 
spi_gath48    <- spi_gath
spi_check48   <- spi_check 
...
# prepare for joining_spi values----
...
# This code chunk examines the really large negative values &
# the NA values by non-closure of  ML estimator for 
# Interior 1-month SPI for Feb & some odd Oral values  
...
# NA values created by non-closure of ML estimator for  
...
# split outliers from typical values & create replace tibble
spi_index_outlier <- spi_index %>% 
  filter(spi_index < -4) %>% 
  as.tibble() 
...
# join replacement values with outlier dates
...
# 4 1936-09-01 cot       -3.25          5
# 5 1936-10-01 cot       -3.25          9
# the Oral outlier values are now fixed 
...
rm(spi_index2, spi_index_outlier, spi_index_replace, 
   spi_index_typical, spi_index_na) 
```
...
rm(spi_corr_aug, spi_corr_gath, spi_index_plot, spi_lm ,spi_lm_fit, 
   spi_lm_tidy, spi_M, spi_M_names, sta_loc)
