...
ggplot() +
  geom_line(data = aep4, aes(V1, V2)) + 
  geom_line(data = gev, aes(V1, V2)) + 
  geom_line(data = glo, aes(V1, V2)) + 
  geom_line(data = gpa, aes(V1, V2)) + 
  geom_line(data = gno, aes(V1, V2)) + 
  geom_line(data = gov, aes(V1, V2)) + 
