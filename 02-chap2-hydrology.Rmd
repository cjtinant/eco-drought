...
## Next Steps: 
1. I turned off the L-moments calculations
2. Working with SPEI package and 'Wichita' dataset
3. Following vignette to see how it is working
4. Check how 'Wichita' works with my code.
5. Run one PRR station through vignette code.

# Idea - I am using 'Date' class rather than 'ts' call - 
#  this might be the reason that I am getting not good values.
