...
# import data----
gage_9398_meta <- import("data/gage_meta_9398.csv") 
gage_9398_raw <- import("data/gage_9398.csv") 

gage_9398_sum <- gage_9398_raw %>% 
  group_by(sta) %>% 
...
# 8 bat_her     1993   1998 
# 9 bev_buf     1993   1998 
#10 bev_pri     1993   1998  
#11 blp_bel     1993   1998 
#12 brsf_co     1993   1998 
#13 che_was     1993   1998 
#14 fal_hot     1993   1998 
#15 frn_fai     1993   1998 
#16 hat_edg     1993   1998 
#17 hor_oel     1993   1998 
#18 lcr_bel     1993   1998 
#19 lcr_vet     1993   1998 
#20 lwr_abv     1993   1998 
#21 lwr_mar     1993   1998 
#22 lwr_ros     1993   1998 
#23 lwr_whi     1993   1998 
#24 rap_far     1993   1998 
#25 spr_her     1993   1998 
#26 wcc_ogl     1993   1998 
#27 whi_kad     1993   1998 
#28 whi_ogl     1993   1998 
#29 whi_sta     1993   1998 
...
# find lambda values for BoxCox transformation  
lambda_q1 <- BoxCox.lambda(gage_depth$q1_depth)   #  q1 ==> 0.006  
lambda_q7 <- BoxCox.lambda(gage_depth$q7_depth)   #  q7 ==> 0.078  
lambda_q30 <- BoxCox.lambda(gage_depth$q30_depth) # q30 ==> 0.086  
...
# glimpse(gage_depth)  # didn't update, yet!
...
#     PC std.dev percent cumulative
#  <dbl>   <dbl>   <dbl>      <dbl>
#1     1   1.69  0.957        0.957
#2     2   0.326 0.0354       0.992
#3     3   0.154 0.00789      1    
...
# clean up Global Environment----
gage_9398_sum <- full_join(gage_9398_meta, gage_sum)
...
ggplot(gage_9398_aug, aes(q7_depth, .fittedPC1, color = factor(sta))) + 
  geom_jitter() + 
  theme_classic() +
  xlab("Q7 depth") +
  ylab("Fitted PC1") + 
...
ggplot(gage_9398_aug, aes(q1_q30_diff, .fittedPC2, color = factor(sta))) +
  geom_jitter() + 
  theme_classic() +
...
ggplot(gage_9398_sum, aes(PC1_mean, PC2_mean)) +
  geom_jitter() + 
...
rm(lambda_q1, lambda_q7, lambda_q30, gage_depth, gage_9398_meta, 
   pca_eigen, pca_meta, pca_vars, gage_aug, pca_input, pca_matrix,  gage_sum) 
```
...
gage_sum <- bind_rows(gage_9398_sum, gage_0317_sum)
...
mc_9398_input <- gage_9398_sum %>% 
  select(q1_mean:q30_mean)

mc_9398_input_meta <- gage_9398_sum %>% 
  select(sta)

gage_clust_l <- Mclust(mc_9398_input) # Model-based-clustering 
...
gage_clust <- bind_cols(mc_9398_input_meta, gage_clust) 

gage_clust <- gage_clust %>% 
  gather(key = group, value = prob, -sta) %>% 
  filter(prob > 0.8) 

gage_9398_sum <- full_join(gage_9398_sum, gage_clust, 
                             by = "sta")
gage_9398_clust <- gage_9398_clust %>% 
  dplyr::select(sta, group, everything())

# Clean up Global Environment
rm(gage_clust, gage_clust_l, mc_9398_input, mc_9398_input_meta)
...
test <- left_join(gage_9398_sum, gage_9398_clust)




ggplot(gage_9398_clust, aes(q7_mean, q1_q30_mean)) + 
