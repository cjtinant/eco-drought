...
# options(tibble.print_max = Inf) # sets tibble output to max
```
...
#   sta     site_no station_nm                                   
# * <chr>     <int> <chr>          
#1 chr_ang 06401500 CHEYENNE R BELOW ANGOSTURA DAM,SD
...
# Next step: probably could be done more efficiently with map_df()
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
gage_int1  <- bind_rows(bat_her, bat_key) 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# export(gage, "data/gage_full.csv") 
...
# ~~~~~~~~~~~~~~~~~~~~~~~
gage_raw <- import("data/gage_full.csv") %>% 
  arrange(sta) %>% 
  select(site_no, sta, Date, i, everything())
gage_meta <- import("data/gage_meta.csv") %>% 
  arrange(sta)

# 2. identify short records using gage_raw$i column
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
num_recs <- gage_raw %>% 
  group_by(sta) %>% 
...
# chr_ang   discharge data jumps from 1978-10-17 to 1979-01-18
