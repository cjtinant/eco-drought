...
#   Complete 1990-15 obs w/o 96 (lcr_abv)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#   Gages post1980; gage               = 41 gages & 374,974 obs 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#     All gages from 90-16             = 22 gages & 270,936 obs           
#   Incomplete gages from 90-16        =  1 gage (lcr_abv) 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#     Complete gages from 90-16        = #31 gages & 61,712 obs# 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 


# 1. filter gages w/ complete 1990-15 obs w/o 96 (lcr_abv)----
# this is to create a second cluster set with lcr_abv 
#   range of years in metadata is 1938-2016 
#   remember waterYear 1990 = Oct 1989 - Sept 1990
#   so the last possible wateryear is 2016
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

# filter gages for water years 1990-2016 
gage_9016_meta <- gage_meta %>% 
  filter(min_yr <= 1989)  %>%
  filter(max_yr >= 2016)           # 22 gages 

gage_9016 <- gage %>% 
  filter(waterYear >= 1990) %>% 
  filter(waterYear <= 2016)        # 270,935 obs


# Identify missing years for 1990-2016 
#gage_incomp <- gage %>% 
#  filter(sta == "lcr_abv") %>%
#  group_by(waterYear) %>%  
#  count() %>% 
...
# take a look at what is entirely dropped 
gage_drop <- anti_join(gage_incomp, gage_9398_meta)
