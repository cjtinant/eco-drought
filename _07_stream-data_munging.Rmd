...
#   Gages w/o 1996+ obs =  7 sta &  82,595 obs (dropped)
#   Gages remaining     = 35 sta & 555,155 obs
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
gage <- anti_join(gage, drop_obs, by = "sta") 
# 637,750 - 82,595 = 555,1555 obs

gage_9297 <- gage %>% 
  filter(min_yr <= 1997) # 538,394 obs
...
# Identify stations with no annual data 1992-1997 
...
meta_lcr_abv <- gage_meta %>% 
  filter(sta == "lcr_abv") 

gage_meta_post97 <- bind_rows(gage_meta_post97, meta_lcr_abv) 

gage_meta_9297 <- gage_meta_9297 %>% 
  filter(sta != "lcr_abv")

gage_meta <- gage_meta %>% 
  filter(sta != "lcr_abv") # 42 to 41 stations
