...
# 2 bat_her 6406500 BATTLE CR BELOW HERMOSA,SD                   
...
gage_ck_prior <- bind_rows(gage_cont_ck, gage_dist_ck)
gage_names  <- gage_ck_prior %>% 
  distinct(sta, site_no) 
  
rm(gage_cont_ck, gage_dist_ck, gage_ck_prior)
...
# List of possible extra sites 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# A tibble: 55 x 3
#   sta     site_no station_nm                                   
# * <chr>     <int> <chr>          
#1 chr_ang 6401500 CHEYENNE R BELOW ANGOSTURA DAM,SD
#2 frn_fai 6403300 FRENCH CR ABOVE FAIRBURN SD      
#3 bat_key 6404000 BATTLE CR NEAR KEYSTONE,SD       
#4 bat_her 6406000 BATTLE CR AT HERMOSA,SD          
#5 spr_her 6408500 SPRING CR NEAR HERMOSA,SD        
#6 nio_gor 6457500 NIOBRARA RIVER NEAR GORDON, NEBR.
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
chr_ang <- readNWISDaily("6401500", parameter_cd, startDate ,endDate)
frn_fai <- readNWISDaily("6403300", parameter_cd, startDate ,endDate) 
bat_key <- readNWISDaily("6404000", parameter_cd, startDate ,endDate) 
bat_her <- readNWISDaily("6406000", parameter_cd, startDate ,endDate) 
spr_her <- readNWISDaily("6408500", parameter_cd, startDate ,endDate)     
nio_gor <- readNWISDaily("6457500", parameter_cd, startDate ,endDate) 
