...
# 2. filter 1980-1992 gage observations 
# 3. filter 1992-1997 gage observations
...
check_sta <- anti_join(gage, gage_comp)
# this shows rap_cre should be dropped   

# update stations by dropping rap_cre
gage_meta <- semi_join(gage_meta, gage_comp) #      41 sta
...
gage_res <- left_join(gage_comp, gage_res) 
...
```{r new}
# Notes: 
# Using water year Oct1 - Sept 31, with year on the majority of months 

# 1. filter gages with complete 1993-1998 observations----
...
# removed lcr_abv - for now - 31 stations 
...
chk_sta <- anti_join(gage_meta, gage_9398_meta) %>% 
  select(1:3) 
...
rm(chk_sta, gage_9398_incomp)

# export 1992-1997
export(gage_9398, "data/gage_9398.csv") 
export(gage_meta_9398, "data/gage_meta_9398.csv") 

# 2. filter gages with complete observations for lcr_abv----
# this is to create a second cluster set with lcr_abv
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
