...
06441000	BAD R NEAR MIDLAND,SD	1991	               bad_mid
...
```{r import_gage_metadata, eval=FALSE} 
  # for some reason Long Pine Creek near Riverview, Nebr. wasn't selected above.
#      most likely because the station is NPS rather than USGS.
