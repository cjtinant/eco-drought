...
```{r create_subsets_for_clustering}
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#     Complete gages from 93-98        = 13 gages &  64,331 obs           
#   Incomplete gages from 93-98        =  1 gage (lcr_abv) 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
#     Complete gages from 90-15 w/o 96 = 18 gages & 238,491 obs 
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# Steps:
# 1. filter gages w/ complete 1993-98 obs (wkc_wok) 
# 2. filter gages w/ complete 1990-15 obs w/o 96 (lcr_abv)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
# Identify missing years for lcr_abv 
gage_incomp <- gage %>% 
  filter(sta == "lcr_abv") %>%
  group_by(waterYear) %>%  
  count() %>% 
