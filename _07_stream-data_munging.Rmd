...
wkc_wok <- wkc_wok %>% 
  mutate(sta = "wkc_wok") %>%
  mutate(site_no = "06446100") #28

# 3. join together in long format
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_cont_top <- bind_rows(bad_mid, bat_bhr, brsf_co, blp_bel,
                                    bev_buf, bev_pri, che_red, che_sce, 
                                    fal_hot, hat_edg, hor_oel, lcr_bel, 
                                    lcr_vet, lwr_mar, lwr_ros)   
  
gage_cont_bot  <- bind_rows(lwr_whi, rap_far, wcc_ogl, whi_int, 
...
rm(bad_mid, bat_bhr, brsf_co, blp_bel, bev_buf, bev_pri, che_red, che_sce, 
                                    fal_hot, hat_edg, hor_oel, lcr_bel, 
                                    lcr_vet, lwr_mar, lwr_ros)  

rm(lwr_whi, rap_far, wcc_ogl, whi_int, whi_kad, whi_ogl, whi_slm, whi_sta, 
                                         whi_whi, wkc_wok, che_buf, che_was, 
                                         whi_roc) 

# bind top and bottom data
...
whi_cha <- readNWISInfo("06445500", parameter_cd, startDate, endDate) 
whi_cha <- readNWISInfo("06445500", parameter_cd) # needed to do this
