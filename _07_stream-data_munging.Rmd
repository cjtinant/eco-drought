...
# Site Number: 06400000 - HAT CR NEAR 
...
#         discharge data jumps from 1979-09-29 to 1984-05-02
# bad_mid discharge data jumps from 1984-05-02 to 1984-06-05
...
wcc_wok <- readNWISDaily("06446100", parameter_cd,startDate,endDate) 
#blc_wan <- readNWISDaily("06446700") # this not working!
...
gage_int4  <- bind_rows(gage_int3, wcc_wok) 
rm(gage_int3, wcc_wok)
