...
#rm(gage_int14, lwr_whi) #
#rm(gage_int15, rap_far) #
#rm(gage_int16, wcc_ogl) #
#rm(gage_int17, whi_int) #
#rm(gage_int18, whi_kad) #
#rm(gage_int19, whi_ogl) # 
#rm(gage_int20, whi_slm) #
#rm(gage_int21, whi_sta) #
#rm(gage_int22, whi_whi) #
#rm(gage_int23, wkc_wok) #
#rm(gage_int24, che_buf) #
#rm(gage_int25, che_was) #
#rm(gage_int26, whi_roc) #
##########################
...
# che-hot      discharge data jumps from 1919-12-06 to 1920-01-22
#               discharge data jumps from 1920-09-30 to 1943-03-01
# fre_fai      discharge data jumps from 1946-01-12 to 1946-01-14 
...
#               discharge data jumps from 2016-08-07 to 2016-08-09
#               61 discharge values are not reported (NA's). 
