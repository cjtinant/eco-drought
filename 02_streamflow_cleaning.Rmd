...
# select complete records for period >1989 to present (n = 30) for SRI  
...
gage_yrs_comp_full <- gage_mon %>%  
  filter(Date > "1987-09-15") %>% 
...
gage_meta <- right_join(gage_meta, gage_yrs_comp_full,  
                           by = "sta")  

gage_yrs_comp <- gage_yrs_comp_full %>% 
  filter(years >= 30)  
