...
```{r import_daily_flow_data, eval=FALSE, message=FALSE} 
...
lambda_q1  <- enframe(  
  BoxCox.lambda(gage_dep$q1_depth)  
  )   
  
lambda_q7  <- enframe(  
  BoxCox.lambda(gage_dep$q7_depth)  
  )   
  
lambda_q30 <- enframe(  
  BoxCox.lambda(gage_dep$q30_depth)  
  )  
...
# Save results  
export(gage_dep, "data/gage_dep.csv")  
...
gage_dep <- full_join(gage_dep, eco_join,  
                  by = "sta")  
