...
4) obtain USGS gage daily flow data for dates:  
   from: 1979-08-01 (WY 1980 + 2 months)  
   to:   2018-12-31 (WY 2018 + 3 months )  
...
```{r add_names_to_gage_meta, message=FALSE, eval=FALSE}  
...
```{r import_daily_flow_data, message=FALSE, eval=FALSE} 
...
# 3. check for incomplete days of record for short recs ====    
