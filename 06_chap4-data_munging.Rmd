---
title: "Precipitation Data-Munging"
...
## General questions addressed with this code chunk:
What is the drought history of the Pine Ridge Reservation?
Does the drought extent differ across the study area?

## Analysis Steps:
1. Data read in from NOAA website  
2. Data munging to check, join and remove NAs 
3. Updated unit vals - originally in tenths of mm; now in mm 
4. Changed daily data into monthly and annual data 
5. Cross-validated monthly data 
6. Created plots 
...
LON - LONG VALLEY 1927 - 2012  - Removed from further analysis  
MIS - MISSION     1951 - 2018  - Removed from further analysis   
...
```{r modeling-results-2, eval = FALSE}
# continued from above
