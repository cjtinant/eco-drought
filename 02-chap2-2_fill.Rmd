...
saveRDS(params, "data/mod_params_run15")   # need to update the file
#write_csv(gage_dv, "data/mod_dvs_run14")
...
rm(miss_lag, miss_lead, gage_pairs, input, gage_ck, gage_ck2, mod_nm, 
   ...
   params, mod, BIC, gage_fill_dv, clust_dv, gage_fill, output) 
```
