...
# 2 streamflow observations plot====  
sri_obs <- sri_1mo %>%   
  ggplot(aes(date, value)) +  
...
spi_sum_tab <- spi_summary %>%  
  ...
  summarise(mean.d_all = median(mean.d),  
...
# 12. clean up global environment====    
rm(sri01_ext,  
   sri01_sevy,  
   sri01_sev,  
   sri01_mod,  
