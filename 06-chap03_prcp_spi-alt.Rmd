...
# * clean up sci.fun vars====  # keep to use below ????#  
rm(distrib,  
   first_mon,  
   p_zero,  
   p_zero_cm,  
...
# need to fix color to gray  -- START HERE  
```{r plot_exceedances}
...
# 4 plot the plots above as a grid & save====  
...
# old code to delete  #   
# plot ecoregion means #  
#  geom_point(data = hydro_group,  
#             shape = 3,  
#             size = 4,  
#             aes(color = hydro_group)) +   
...
# * need to drop NA vals prior to decomp_fun() then prepare results for join====  
...
# 7 pivot wider and drop non-important vars
...
# 6 identify seasonally intermittant streams (NEED TO FIX====  
...
export(sri_seas2, "data/sri_seas2.csv")  
...
# calculate SCI for trend and season  
