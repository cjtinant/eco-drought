...
# 1 pivot SCI dfs wider and drop non-important vars====  
...
# 2 add location to mclust dataframe====  
...
sci_corr <- full_join(spi_decomp, sri_decomp,  
                       by = c("date", "location")) %>%  
