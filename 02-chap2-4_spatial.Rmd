...
env_vars <- env_vars %>% 
  ...
  select(area_linv, cat_area_ln, cout_sqr, cat_out, crel_sqr, cat_rel, 
         dden_sqr, drain_dens, ksat_ln, ksat_mean, kvert_ln, kvert_mean, 
         lwrat_sqr, lw_ratio, pcov_ln, perc_cov, prcp_sq, prcp_mean, 
         slop_ln, slop_med, t07_sq, t07_mean, TWI_sq, TWI_mean, vpd07_sq, 
         vpd_07, vpd_ann, vpdan_sq) 
...
env_vars <- env_vars %>% 
  select(area_linv, cout_sqr, crel_sqr, cat_rel, dden_sqr, ksat_ln, kvert_ln, 
         lwrat_sqr, pcov_ln, prcp_sq, slop_ln, slop_med, t07_sq, TWI_sq,
         TWI_mean, vpd07_sq, vpdan_sq) 
