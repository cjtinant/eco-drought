...
```{r fill_using_pca_run} 
# 1.  prepare to join lead and lag stations using station pairs from run above  
# create a summary table
gage_pairs <- pca_sum %>% 
  mutate(sta_lead = lead(sta, 
                     order_by = q30_mean_dep)) %>%   # creates a lead col 
  mutate(sta_lag = lag(sta, 
                     order_by = q30_mean_dep)) %>%   # creates a  lag col 
  select(name, everything())  


# 1.1 add lead Q30 information to summary table -updated 
...
# 1.2 add lag information to summary table & clean up - updated 
...
# 3. find missing gages looking backward and forward & select stations to fill
...
# join the missing gages and arrange them
gage_miss <- semi_join(gage_pairs, gage_miss, by = "sta")  %>% 
 mutate(q30_diff.lead = abs(q30_mean_dep.sta - q30_mean_dep.lead)) %>%  
  mutate(q30_diff.lag = abs(q30_mean_dep.sta  - q30_mean_dep.lag)) %>%  
  mutate(sta_fill = if_else(
    q30_diff.lead < q30_diff.lag, 
    sta_lead, sta_lag)
  ) %>% 
  arrange(q30_diff.lag) %>% 
  arrange(q30_diff.lead) %>% 
...
# 4. fix if there is an NA in the lead or lag slot & clean up 
gage_miss <- gage_miss %>% 
...
rm(gage_fill, gage_fill_dups, gage_miss, gage_pairs, 
   ...
   lambda_q7, lambda_q30, pca_matrix) 
...
# 'wkn_wok' & friends. ok. 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# input data for the pca run 

# update tracking counter 
i <- i +1 

run_name <- paste0("run_0", i) 
...
# this run is fill missing records using pca above 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# update input data  
miss_min <- yr_min %>% 
  as_tibble() %>% 
...
# 4.5. fix if there is an NA in the lead or lag slot
gage_miss <- gage_miss %>% 
  mutate(sta_fill = case_when(
    is.na(sta_lead) ~ sta_lag, 
    is.na(sta_lag) ~ sta_lead,
...
```{r streamflow_sqrtQ30_run_02-old}
# this run is find missing records for short-year station 
# 'wkn_wok' & friends. ok. 
...
# 2. Transform Q30 using sqrt---- - 
pca_input <- pca_input %>% 
  mutate(q1_tr = sqrt(q1_depth)) %>%
  mutate(q7_tr = sqrt(q7_depth)) %>%
  mutate(q30_tr = sqrt(q30_depth)) %>%
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# che_buf min years in a group is actually '2008'
yr_min <- 2008 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# che_buf min years in a group is actually '2005'
yr_min <- 2005 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
yr_max <- as_vector(yr_len %>%  
                      select(max_yr) %>%
...
# this run is find missing records for short-year station using PCA above 
...
# this run is find missing records for short-year stations 
# 'lcr_abv' 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
yr_min <- 1984   # whi_slm has a non-continuous time series 
...
# NOTE: THIS HAS AN ENDLESS LOOP IN CHE-SCE & WHI-WHI
# this run is find missing records for short-year station 
#   from PCA above 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# update input data  
...
# NOTE THERE IS A FIXED ENDLESS LOOP BELOW
...
# NOTE THERE IS CODE IN THIS CHUNK TO FIX AN ENDLESS LOOP 
# this run is find missing records for short-year station 
#   from PCA above 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# update input data  
...
gage_miss <- gage_miss %>% 
  ...
  arrange(PC1_mean.lead) %>% 
  arrange(PC1_mean.lag) 
...
# NOTE CODE BELOW TO FIX AN ENDLESS LOOP 
# this run is find missing records for short-year station 
#   from PCA above 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
# update input data  
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_33  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
yr_min <- 1988 # che_pla has a data gap 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_34  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_35  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_36  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
```{r fill_using_pca_run_37} 
# NOTE CODE IN THIS CHUNK TO FIX AN ENDLESS LOOP 
# this run is find missing records for short-year station 
#   from PCA above  
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
# update input data   
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_37  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_38  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_39  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_40  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_41  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_42  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_43  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_44  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_45  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_46  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_47  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
gage_dv_48  <- bind_rows(last_dv, gage_fill) %>% 
  distinct() 
...
#write_csv(gage_dv_48, "gage_fill_pc1.csv") 
#write_csv(vals_lambda, "gage_pc1_lambdas.csv") 
#write_csv(vals_eigen, "gage_pc1_eigen.csv") 
#write_csv(vals_eigen, "gage_pc1_pca.csv") 
```
