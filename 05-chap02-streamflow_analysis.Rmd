...
model_plot_wsd <- error_vals_wsd %>% 
 ...
 # ylim(0, 0.75) +   
  labs(x = "",    
       y = bquote('wsd model error')) +     
  theme_bw()   
  
# join the plots====  
cowplot::plot_grid(   
  model_plot_pc1, model_plot_pc2, model_plot_wsd,  
  ncol = 1, align = "v")   
  
cowplot::ggsave2("figure/glm_model_fit_new.png",   
        units = "in",    
        width = 7, 
        height = 6)  
...
```{r 23c-export-table_glm-coeffs_pc2, eval=FALSE} 
# set the numeric columns   
...
# prior results to potentially delete  
