...
model_plot_pc2 <- error_vals_pc2 %>% 
 ...
 # ylim(0, 0.75) +   
  labs(x = "",    
       y = bquote('PC2 model error')) +     
  theme_bw()   
  
cowplot::plot_grid(   
  model_plot_pc1, model_plot_pc2, 
  ncol = 1, align = "v")   
...
```{r 19-get_glm_observations_and_predictions}  
...
```{r 20-prepare_glm_observations_predictions_plot}
  
# set the facet labels, find number of test observations, get mae  
labels_pc1 <- c(elastic = "Elastic net predicted values - PC1",  
               null_mod = "Mean of daily observations - PC1")   
  
labels_pc2 <- c(elastic = "Elastic net predicted values - PC2",  
...
# PC1 observations vs predictions plot====  
...
cowplot::plot_grid(   
  obs_pred_plot_pc1, obs_pred_plot_pc2, 
  ncol = 1, align = "v")   
...
```{r plot_glm_residuals, eval=FALSE}
...
```{r 15b-export-table_glm-coeffs_pc2, eval=FALSE} 
# set the numeric columns   
...
```{r 16b-select-glm-model_pc2-DROP}
...
```{r 17b-plot-glm-models_pc2-DROP} 
...
```{r 18b-get_glm_observations_and_predictions_pc2-DROP}  
...
```{r 19b-plot_glm_observations_predictions_pc2-DROP}
