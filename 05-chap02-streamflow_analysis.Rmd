...
```     
#  createDataPartition(gaged$log_q1_depth, p=0.8)[[1]]  
...
```{r 16-export-table_glm-coeffs_mon} 
...
```{r 19-get_glm_observations_and_predictions_mon}  
...
```{r 20-plot_glm_observations_predictions_mon}
