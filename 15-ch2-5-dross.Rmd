...
```{r plot_flow-duration-curve_data_ecoreg, eval=FALSE} 
...
```{r prepare_mixed_model, eval=FALSE}
...
```{r export-mixed-model-table, eval=FALSE}
...
```{r select-glm-model_ecoreg, eval=FALSE}
