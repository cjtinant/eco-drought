...
[1] "site_no"              
 ...
 [8] "huc_cd"               
 [9] "drain_area_va"        
[10] "contrib_drain_area_va"

gage_poss           possible USGS gaging stations in the study area 
gage_meta_poss      metadata for possible gaging stations
-- _int1            scratch variable for pulling sites with integer fields 
-- _int2            scratch variable for pulling sites with integer fields 
-- _char            scratch variable for pulling sites with character fields 
...
```{r clean_metadata, eval=FALSE}

# clean the imported metadata 
...
# 1. create a list of active gages & get metadata for water year 1980-2018 
