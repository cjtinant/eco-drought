...
coefs <- coefs %>% 
  ...
  mutate(pc2_arrange = abs(pc2_lasso)) %>% 
  ...
  select(coeff,pc1_lasso, pc2_lasso, 
         pc1_elastic, pc2_elastic, 
         pc1_ridge, pc2_ridge)  
...
# ---------------------------------------------------------------------------- 
observed_train   <- tibble(observed = train_pc1$pc1_sta) 
preds_train <- map_dfc(models_pc1, predict, newdata = train_pc1) 
fit_train <- bind_cols(observed_train, preds_train) 

#  prepare to plot test observations and predictions 
observed_test   <- tibble(observed = test_pc1$pc1_sta) 
