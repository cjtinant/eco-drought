...
rm(cores, lambda, seed, reg.ctrl, ecoreg_index, ecoreg_list)  
...
```{r plot_flow-duration-curve_ecoreg} 
...
#  exceed   flow   'pshale' 'escarp' 'wrbadl' 'bhplat' 'kptabl' 'sndhil' 
#    low    high     75%      67%      none     10%       5%      none       
#    high   low      75%      67%      none     10%       5%      none       

ggsave("figure/freq_plot_eco.png", width = 7, height = 7, units = "in")  
```

```{r plot_flow-duration-curve_resid_ecoreg} 
...
# flow duration curve plot - differences between models --------------------- 
...
# add text of the null model MAE 
  geom_text(data = mae_ecoreg, 
            x = 2, y = 3.5,  
           aes(label= paste("MAE null model =", null_mod, sep = " ")), 
           size = 2.5, 
           color = "gray70" 
           ) +   
# add text of the predicted model MAE 
  geom_text(data = mae_ecoreg, 
            x = 2, y = 3.0,  
           aes(label= paste("MAE lasso =", predicted, sep = " ")), 
           size = 2.5, 
           color = "gray30" 
           ) + 
  scale_x_continuous(name = 'Percentage of time flow exceeded',
...
#  exceed   flow   'pshale' 'escarp' 'wrbadl' 'bhplat' 'kptabl' 'sndhil' 
#    low    s     70%      60%      70%      10%       10%       0%       
#    high   low     100%      90%      90%      60%       60%      60%       

ggsave("figure/freq_plot_eco_diff.png", width = 7, height = 7, units = "in")  
``` 
