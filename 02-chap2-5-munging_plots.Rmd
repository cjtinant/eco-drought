...
```{r ci_results, eval=FALSE} 
# IN PROGRESS -- code is from abobe
# prepare df for gaging station metadata  
gage_table <- gage_meta %>%   
  mutate(contrib_drain_area_va = 
           coalesce(contrib_drain_area_va, drain_area_va) 
...
# reframe results from av

# use the listviewer to find the shape of the list 
listviewer::jsonedit(ci_input_pc1) 

# pluck results for summary table
