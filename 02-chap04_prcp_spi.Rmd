...
sta_alt, sta_fil, sta_meta_input, sta_miss_day, sta_short_name,   
   sta_input)   
...
export(sta_dv_plus, "data/sta_dv_plus.csv")    
...
```{r download-station-data, eval=FALSE}
...
export(sta_fin, "data/sta_fin.csv")  
...
sta_fin <- import("data/sta_fin.csv") %>%  
  mutate(date = ymd(date)) %>%  
  mutate(yr = year(date)) %>%    
