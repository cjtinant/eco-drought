...
export(spi_all, "data/spi_fin.csv")  
...
# 1.  prep to deconvolute prcp into trend, seasonal & random comps----  
# 1.1 identify frequency of seasonality -- should be 12 months====   
spi01_freq <- spi_fin  %>% 
...
# 1.2 identify trend of periodicity -- should be 60 months====
spi01_trend <- spi_fin  %>% 
  select(sta, date, spi_1mo) %>%  
  split(.$sta) %>% 
...
# 1.3 create inputs====  
decomp_input <- bind_cols(spi01_freq, spi01_trend)  
rm(spi01_freq, spi01_trend)  

# 2. make function to decompose into seasonal, trend, & remainder----  
...
# 3. decompose SPI into seasonal, trend, & remainder----  
# spi_01mo====  
TARGET <- "spi_1mo"  
spi01  <- spi_fin %>% 
  select(sta, date, spi_1mo) %>% 
