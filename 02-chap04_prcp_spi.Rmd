...
# The geographical extent given as SElat, SElon, NElat, NElon

stations_poss <- ncdc_stations(extent = c(42, -104, 44.2, -100.5), 
                               limit = 1000) %>%      # n = 401
...
test <- (stationid = sta_input$id, ncdc_stations) %>% 
    pluck("data") 

test <- ncdc_stations(stationid = "GHCND:USW00024090") #%>% 
    pluck("data") 
