...
# SCI calcs - bha_bev -- set up the station for sci & make sci list vars####  
sta      <- bhp_bev_v  
sci_1mo  <- sci.fun(sta, 1)                             
sci_2mo  <- sci.fun(sta, 2)                             
sci_3mo  <- sci.fun(sta, 3)                             
...
sta      <- bhp_frn_v   
sci_1mo  <- sci.fun(sta, 1)                             
sci_2mo  <- sci.fun(sta, 2)    # MLE fail for month 4-, 11-                 
sci_3mo  <- sci.fun(sta, 3)           
...
sta      <- pre_ogl_v  
sci_1mo  <- sci.fun(sta, 1)                       
sci_2mo  <- sci.fun(sta, 2)    # MLE fail month 9-, 11-                     
...
sci_9mo  <- sci.fun(sta, 9)    # MLE fail months 2-               
...
sta      <- snd_nio_v  
sci_1mo  <- sci.fun(sta, 1)                      
sci_2mo  <- sci.fun(sta, 2)    # MLE fail month 2-                        
sci_3mo  <- sci.fun(sta, 3)       
sci_4mo  <- sci.fun(sta, 4)    
sci_6mo  <- sci.fun(sta, 6)      
sci_9mo  <- sci.fun(sta, 9)         
