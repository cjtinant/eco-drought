...
# L-moments 
```{r lmoments_prcp, include=FALSE, eval=FALSE}
...
sta_meta_fin <- full_join(sta_meta_fin, lmom_sta,   
                           by = "sta")   
...
```{r lmoments_streamflow, include=FALSE, eval=FALSE}
