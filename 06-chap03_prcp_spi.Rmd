...
# prepare spi function vector inputs (1989-01 to 2017-01)----   
# north-west (NW)   
sta_rap <- sta_pres %>%   
  arrange(date) %>%  
  filter(sta == "RAP")   
...
cot <- as.double(sta_cot$log_q1_mon)   
...
oni <- as.double(sta_oni$log_q1_mon)   
...
oel <- as.double(sta_oel$log_q1_mon)   
...
gor <- as.double(sta_gor$log_q1_mon)   
...
mis <- as.double(sta_mis$log_q1_mon)   
