...
psp_bat <- as.double(psp_bat$log_q1_mon)   
psp_brs <- as.double(psp_brs$log_q1_mon)   
psp_che <- as.double(psp_che$log_q1_mon)   
psp_elk <- as.double(psp_elk$log_q1_mon)   
psp_hat <- as.double(psp_hat$log_q1_mon)   
psp_whi <- as.double(psp_whi$log_q1_mon)   
...
pre_ogl <- as.double(pre_ogl$log_q1_mon)   
pre_sta <- as.double(pre_sta$log_q1_mon)   
