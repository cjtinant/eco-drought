...
ggplot(lmom_data,   
  ...
  scale_shape_discrete(name = "Flow regime") +
  scale_colour_grey(
    breaks = rev(
...
```{r identify_streamflow_locations}
# import full streamflow records----   
gage_mon_full <- import("data/gage_mon_full.csv") 
lmom_gage_meta <-  import("data/gage_meta_lmom.csv")  

# create groups of stations by region & refactor levels====      
lmom_gage_meta <- lmom_gage_meta %>%   
  mutate(north_group = case_when(   
    dec_lat_va > 43.5 ~ "N",   
    TRUE ~ "S")   
  ) %>%   
...
# plot the theoretical distributions, and groups====     
ggplot(lmom_gage_meta, 
       aes(x = L_skew,  
           y = L_kurtosis 
       )) + 
